...
class PurchaseOrder(generic.BO):
    ...
    partner = models.ForeignKey(Partner,verbose_name=_("partner"), on_delete=models.CASCADE,limit_choices_to={"partner_type":"S"})
...
class POItem(models.Model):
    ...
    material = models.ForeignKey(Material,verbose_name=_("material"), on_delete=models.CASCADE,limit_choices_to={"is_virtual":"0"})
    ...
    woitem = models.ForeignKey(WOItem,verbose_name=_("wo item"), on_delete=models.CASCADE,blank=True,null=True)
