...
class WorkOrder(generic.BO):
    ...
    refer = models.ForeignKey("self",verbose_name=_("refer wo"), on_delete=models.CASCADE,blank=True,null=True)
    ...
    service = models.ForeignKey(Material,verbose_name=_("service name"), on_delete=models.CASCADE,null=True,blank=True,limit_choices_to={"is_virtual":"1"})
    project = models.ForeignKey(Project,verbose_name=_("project"), on_delete=models.CASCADE,null=True,blank=True)
...
class WOItem(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,verbose_name=_("workorder"), on_delete=models.CASCADE)
    material = models.ForeignKey(Material,verbose_name=_("material"), on_delete=models.CASCADE,null=True,blank=True,limit_choices_to={"is_virtual":"0"})
...
class Reimbursement(generic.BO):
    ...
    description = models.TextField(_("description"),blank=True,null=True)
    project = models.ForeignKey(Project,verbose_name=_("project"), on_delete=models.CASCADE)
    wo = models.ForeignKey(WorkOrder,verbose_name=_("work order"), on_delete=models.CASCADE,null=True,blank=True)
    user = models.ForeignKey(User,verbose_name=_("user"), on_delete=models.CASCADE,blank=True,null=True)
    org = models.ForeignKey(OrgUnit,verbose_name=_("cost center"), on_delete=models.CASCADE,blank=True,null=True)
    ...
    loan = models.ForeignKey(Loan,verbose_name=_("loan record"), on_delete=models.CASCADE,blank=True,null=True)
    loan_amount = models.DecimalField(_("loan amount"),max_digits=10,decimal_places=2,blank=True,null=True)
    logout_amount = models.DecimalField(_("logout amount"),max_digits=10,decimal_places=2,blank=True,null=True)
...
class Activity(generic.BO):
    ...
    room = models.ForeignKey(Material,verbose_name=_("room"), on_delete=models.CASCADE,blank=True,null=True,limit_choices_to={'tp':20})
