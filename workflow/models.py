...
class Modal(models.Model):
    ...
    content_type = models.ForeignKey(ContentType,verbose_name=_("content type"), on_delete=models.CASCADE,limit_choices_to={"app_label__in":['basedata','organ']})
...
class Instance(models.Model):
    ...
    starter = models.ForeignKey(User,verbose_name=_("start user"), on_delete=models.CASCADE,related_name="starter")
...
class History(models.Model):
    ...
    node = models.ForeignKey(Node,verbose_name=_("workflow node"), on_delete=models.CASCADE,blank=True,null=True)
...
class TodoList(models.Model):
    ...
    inst = models.ForeignKey(Instance,verbose_name=_("workflow instance"), on_delete=models.CASCADE)
    node = models.ForeignKey(Node,verbose_name=_("current node"), on_delete=models.CASCADE,blank=True,null=True)
    app_name = models.CharField(_("app name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    model_name = models.CharField(_("model name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
